...
This page contains a comprehensive list of error codes used in our smart contracts. These codes are automatically generated from the source code.
...
## contracts/taikoon/MerkleWhitelist.sol

| Error | Code |
|-------|------|
| `MINTS_EXCEEDED()` | `0x9ea134e9` |
| `INVALID_PROOF()` | `0x712eb087` |
| `INVALID_TOKEN_AMOUNT()` | `0x2658ce77` |
| `ADDRESS_BLACKLISTED()` | `0x7874e363` |

## contracts/taikoon/TaikoonToken.sol

| Error | Code |
|-------|------|
| `MAX_MINTS_EXCEEDED()` | `0x6fee0b11` |
| `MAX_SUPPLY_REACHED()` | `0xfb67a12d` |
| `MINTER_NOT_WHITELISTED()` | `0x8486bf24` |
| `TOKEN_NOT_MINTED()` | `0x507b1e44` |

## contracts/trailblazers-airdrop/ERC20Airdrop.sol

| Error | Code |
|-------|------|
| `ADDRESS_BLACKLISTED()` | `0x7874e363` |

## contracts/trailblazers-airdrop/MerkleClaimable.sol
...
## contracts/trailblazers-badges/ECDSAWhitelist.sol

| Error | Code |
|-------|------|
| `MINTS_EXCEEDED()` | `0x9ea134e9` |
| `ADDRESS_BLACKLISTED()` | `0x7874e363` |
| `ONLY_MINT_SIGNER()` | `0x30143ce2` |
...
|-------|------|
| `MINTER_NOT_WHITELISTED()` | `0x8486bf24` |
| `INVALID_INPUT()` | `0xb68600c7` |
| `INVALID_BADGE_ID()` | `0xaaaf9a6a` |
| `INVALID_MOVEMENT_ID()` | `0x589a236e` |

## contracts/snaefell/SnaefellToken.sol
...
| `MINTER_NOT_WHITELISTED()` | `0x8486bf24` |
| `TOKEN_NOT_MINTED()` | `0x507b1e44` |
| `TOKEN_CANNOT_BE_TRANSFERRED()` | `0x3871b247` |

## contracts/snaefell/MerkleWhitelist.sol
...
## contracts/party-ticket/TaikoPartyTicket.sol

| Error | Code |
|-------|------|
| `INSUFFICIENT_MINT_FEE()` | `0x34227321` |
| `CANNOT_REVOKE_NON_WINNER()` | `0xcac84894` |
| `ADDRESS_BLACKLISTED()` | `0x7874e363` |
