...
## surge/cross-chain-dex/WETH9Stub.sol

| Error | Code |
|-------|------|
| `INSUFFICIENT_BALANCE()` | `0x50b1f356` |
| `INSUFFICIENT_ALLOWANCE()` | `0x0fd39193` |
| `ETH_TRANSFER_FAILED()` | `0x98ce269a` |
...
| `INSUFFICIENT_ETH_BALANCE()` | `0xae4da304` |
| `ETH_TRANSFER_FAILED()` | `0x98ce269a` |
| `UNKNOWN_ACTION()` | `0x0427f699` |

## surge/cross-chain-dex/SimpleDEXL1.sol

| Error | Code |
|-------|------|
| `ONLY_ADMIN()` | `0x97f0062c` |
| `ZERO_AMOUNT()` | `0xf6fa5450` |
| `INVALID_PATH()` | `0xd8e76d79` |
| `EXPIRED()` | `0x414ac85b` |
...
| `UNKNOWN_ACTION()` | `0x0427f699` |
| `ZERO_AMOUNT()` | `0xf6fa5450` |
| `INVALID_RETURN_MESSAGE()` | `0xb0e28ce5` |
| `ETH_TRANSFER_FAILED()` | `0x98ce269a` |
