...
A subagent prompt at [`simple-surge-node/agent-prompts/deploy-mock-prover.md`](https://github.com/NethermindEth/simple-surge-node/blob/main/agent-prompts/deploy-mock-prover.md) runs this whole guide end-to-end — clone, env setup, deploy, verify. Fill in the placeholders at the top and paste the fenced block into LLM model. See the [running-surge index](..) for the full set of variants.
:::
...
See [Prover Setup](./provers) — minimum 1x RTX 3090 (24 GB VRAM); multi-GPU L40 / RTX 5090 recommended for real-time-feel proof times.
...
- [Enable privacy mode](./privacy-mode) to encrypt blob payloads end-to-end
