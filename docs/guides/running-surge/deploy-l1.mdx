---
title: Deploying an L1 Network
sidebar_position: 1
---

# Deploying an L1 Network

This guide explains how to deploy an L1 development network using Kurtosis. This setup includes deploying the Taiko protocol on L1, which is required for launching the Surge devnet. By the end, you'll have a fully functional L1 environment running within a Kurtosis enclave.
...
:::info What's Next?
With your L1 environment deployed, you can now proceed deploying an L2 node.
:::
