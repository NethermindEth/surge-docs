...
Follow these steps to add your custom chain id to the Safe contracts:

### 1. For Safe Deployments Repository

Fork the [Safe Deployments](https://github.com/safe-global/safe-deployments) repository to your own GitHub account.
...
```bash
git clone https://github.com/<your-github-username>/safe-deployments.git
cd safe-deployments
```

### 3. Add Chain ID to Safe Deployments
...
Make sure to update the `RPC_NODE_URL` to your RPC endpoint.
