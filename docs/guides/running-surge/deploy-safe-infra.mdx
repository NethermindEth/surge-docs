...
Clone the [Safe Deployments](https://github.com/safe-global/safe-deployments) repository and navigate into the directory:

```bash
git clone https://github.com/safe-global/safe-deployments.git
cd safe-deployments
```
