...
Before starting any components, create the required Docker network:
...
<TabItem value="script" label="Option B: Shell Script">
...
You'll see the same prompts as in the [3. Start Protocol Deployment Script section](../running-surge/deploy-l2.mdx#3-start-protocol-deployment-script).
...
Choose the option that best fits your testing or running needs. For a full setup, select option `5` to run all components except the spammer.
