...
Switch to the correct branch (`surge/hoodi`):
...
```
:::note
Make sure to update `.default.env` to match your environment such as updating `L1_RPC_URL` and `L2_RPC_URL` to your own node URLs.
:::
